# SAT Practice Resources — the best-of, and how to use each

**Why this matters for your score:** the tutor teaches you the *methods*; you build the *reps* on real questions. Using the right resources — official first — is what turns method into a 1500+. **And the #1 discipline: review every practice test with your error log. A test taken without review is wasted.**
...
| **The College Panda (Nielson Phu)** | ~$20–25/book | The consensus **core Math** resource for high scorers (clear methods + 10 practice tests); also a concise grammar book | **Math** mastery + extra practice tests. Great for a 1500+ math target. |

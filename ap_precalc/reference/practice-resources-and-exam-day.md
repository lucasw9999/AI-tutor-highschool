...
**AP Classroom** (apclassroom.collegeboard.org, course code **117**): the big **secure** bank of practice MCQ/FRQ + AP Daily videos.
- It's **gated to authorized educators** — a self-studying student **can't** open it directly. **Get a join code from Lucas's AP Precalc teacher or AP Coordinator.** If/when he's enrolled, this is the richest practice source.

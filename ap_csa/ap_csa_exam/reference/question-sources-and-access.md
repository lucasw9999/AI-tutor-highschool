...
| **AP Classroom** (the real item bank) | Free — **teacher-gated** | The authoritative secure bank: Progress Checks, Question Bank, AP Daily videos, full secure practice exams | See access section below — **requires a join code from an AP-authorized teacher** |
...
4. AP Central past FRQs (Q1/Q3/Q4 any year; Q2 post-redesign only).

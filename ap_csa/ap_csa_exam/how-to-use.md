...
Readiness = consistent 5-range composites across ≥3 full mocks, plus ≥85% Analyze-Code accuracy and ≥85% per-FRQ-type points. See `README.md` for the full four-metric bar.

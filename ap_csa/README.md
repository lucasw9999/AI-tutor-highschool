...
Exam: 42 MCQ (55%) + 4 FRQ (45%), 3 hrs, digital Bluebook, Java Quick Reference provided. FRQ points: Q1=7, Q2=7, Q3=5, Q4=6 (=25). Units & MCQ weight: U1 Using Objects 15–25%, U2 Selection/Iteration 25–35%, U3 Class Creation 10–18%, U4 Data Collections 30–40%. **Inheritance: the words are IN, the code is OUT** — superclass/subclass/class hierarchy and "every class is a subclass of `Object`" are required Unit 1 content (topic 1.12); the CED excludes *"designing and implementing inheritance relationships"*, and polymorphism and abstract classes appear nowhere in it (verified 12 August 2026). ~25–27% of takers score 5. *Coverage map cross-checked line-by-line against the official **CED, Effective Fall 2025** (all 53 topics, 1.1–4.17).*
